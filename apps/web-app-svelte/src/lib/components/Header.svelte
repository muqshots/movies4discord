...
<div
    ...
    >
      <div
        class="mt-1 cursor-pointer md:hidden"
      ...
      <div class="cursor-pointer">
        ...
        <div class="group flex flex-row gap-2">
            ...
            <div class="duration-250 absolute right-3 z-50 mt-[3.45rem] w-56 origin-top-right scale-0 rounded-lg border bg-theme px-5 py-5 shadow transition ease-in-out group-hover:scale-100">
